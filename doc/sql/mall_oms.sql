...
CREATE TABLE `oms_order`  (
                              ...
                              `pay_type` int NULL DEFAULT NULL COMMENT '支付方式【PAYPAL中国->101；PAYPAL香港->102；PAYPAL全球->103；支付宝->201；支付宝香港->202；支付宝全球->203；微信->301；微信香港->302；微信全球->303；银联->401；货到付款->501】',
