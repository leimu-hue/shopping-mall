...
CREATE TABLE `wms_purchase`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `wms_purchase_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购需求' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `wms_ware_order_task`  (
  ...
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'create_time',
  `ware_id` bigint NULL DEFAULT NULL COMMENT '仓库id',
